 ...
 * @Author: zhuoda
 * @Date: 2021-08-03
 * @LastEditTime: 2021-11-16 15:22:25
...
export default {
  install: (app, smartEnumWrapper) => {
    ...
    smartEnumPlugin.getDescByValue = function (constantName, value) {
      if (
        !smartEnumWrapper ||
        !Object.prototype.hasOwnProperty.call(smartEnumWrapper, constantName)
      ) {
        return "";
      }
      // boolean类型需要做特殊处理
      if (
        constantName === "FLAG_NUMBER_ENUM" &&
        !_.isUndefined(value) &&
        typeof value === "boolean"
      ) {
        value = value
          ? FLAG_NUMBER_ENUM.TRUE.value
          : FLAG_NUMBER_ENUM.FALSE.value;
      }
