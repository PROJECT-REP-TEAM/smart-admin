  ...
  <el-form class='smart-query-form'>
    <el-row class='smart-query-form-row'>
      ...
      <el-form-item class='smart-query-form-item smart-margin-left10'>
        <el-button v-privilege="'system:menu:query'" type='primary' @click='query' icon='Search'>
          查询
        </el-button>
  ...
  <el-card shadow='hover'>
    <el-row class='smart-table-btn-block'>
      <div class='smart-table-operate-block'>
        <el-button v-privilege="'system:menu:add'" type='primary' size='small' @click='showDrawer' icon='Plus'>
          添加菜单
        </el-button>

        <el-button v-privilege="'system:menu:delete'" type='danger'
                   size='small'
                   @click='batchDelete'
    ...
    >
      ...
      <el-table-column prop='operate' label='操作' width='150'>
        <template #default='scope'>
          <el-button v-privilege="'system:menu:update'" link type='primary' size='small' @click='showDrawer(scope.row)'>
            编辑
          </el-button>
          <el-button v-privilege="'system:menu:delete'" link type='danger' size='small'
