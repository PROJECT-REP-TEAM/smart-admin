 ...
 * @LastEditors: zhuoda
 * @Description:
 * @FilePath: /smart-admin/src/views/system/employee/role/components/role-datel-scope/index.vue
-->
<template>
  <div>
    <div class='btn-group'>
      <el-button v-privilege="'system:role:dataScope:update'" class='button-style' type='primary'
