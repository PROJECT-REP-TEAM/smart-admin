...
<template>
  <div>
    <div class="header">
      <p>管理拥有当前角色权限的人员列表</p>
      <div>
        <el-button v-privilege="'system:role:employee:add'" class="button-style" v-if="selectRoleId" type="primary" @click="addRoleEmployee">添加成员</el-button>
        <el-button v-privilege="'system:role:employee:batch:delete'" class="button-style" v-if="selectRoleId" type="danger" danger @click="batchDelete">批量移除</el-button>
      </div>
    </div>
    <el-table ref="table"
              @select="onSelect"
