 ...
 * @LastEditTime: 2022-06-05 17:41:42
 * @LastEditors: LiHaiFan
 * @Description: 
 * @FilePath: \typescript-element-plus-vue\src\components\side-expand\side-menu\index.vue
-->
<template>
...
<script setup lang="ts">
  ...
  const showRecursionMenu = computed(
    () => selectedMenu.value && selectedMenu.value.children && selectedMenu.value.children.some((e) => e.visibleFlag)
  );
  // ----------------------- 以下是生命周期 ---------------------------------
