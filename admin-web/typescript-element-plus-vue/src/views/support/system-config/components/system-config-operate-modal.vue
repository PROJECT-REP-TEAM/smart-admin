 ...
 * @LastEditTime: 2022-06-05 22:52:08
-->
<template>
  <el-drawer v-model="visible" :title="form.systemConfigId ? '编辑' : '添加'" @close="onClose">
...
<script setup lang="ts">
  ...
  // ----------------------- 以下是方法 ------------------------
  function showModal(rowData?: SystemConfigUpdateForm) {
