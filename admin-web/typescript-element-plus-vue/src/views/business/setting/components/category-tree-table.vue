<template>
  <el-card shadow="hover">
    ...
    <el-table size="small" :data="tableData" :rowKey="rowKey" @expand-change="changeExpand" :expand-row-keys="expandedRowKeys">
...
<script setup lang="ts">
  ...
  function changeExpand(val: CategoryTreeVo[]) {
    expandedRowKeys.value = val.map((e: any) => e[rowKey.value]);
  }
