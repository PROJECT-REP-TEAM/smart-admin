    ...
    <el-col :span="12">
      <el-card header="待办事项">
        <div class="content large wait-handle">
          <p>
            <el-tag color="#108ee9">审批</el-tag> 有{{ 0 }}个审批待审核
            <a>查看更多></a>
          </p>
          <p>
            <el-tag color="#f50">退款</el-tag> 有{{ 0 }}个退款被驳回
            <a>查看更多></a>
          </p>
          <p>
            <el-tag color="#2db7f5">缺陷</el-tag> 有{{ 0 }}个缺陷被找到
            <a>查看更多></a>
          </p>
          <p>
            <el-tag color="#d3adf7">尾款</el-tag> 有{{ 0 }}元尾款待收回
            <a>查看更多></a>
          </p>
          <p>
            <el-tag color="#87d068">合同</el-tag> 有{{ 0 }}个合同工客户已签署
            <a>查看更多></a>
          </p>
          <p>
            <el-tag color="#108ee9">问题</el-tag> 有{{ 0 }}个问题被驳回
            <a>查看更多></a>
          </p>
          <p>
            <el-tag color="#f50">能量</el-tag> 有{{ 0 }}个能量被收取
            <a>查看更多></a>
          </p>
        </div>
      </el-card>
