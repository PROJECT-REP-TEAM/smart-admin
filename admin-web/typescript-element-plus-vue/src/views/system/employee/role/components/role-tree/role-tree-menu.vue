 ...
 * @LastEditTime: 2022-06-05 23:01:37
 * @LastEditors: LiHaiFan
 * @Description:
 * @FilePath: \typescript-element-plus-vue\src\views\system\employee\role\components\role-tree\role-tree-menu.vue
-->
<template>
  <li v-for="module in props.tree" :key="module.menuId">
    <div class="menu" :style="{ marginLeft: `${props.index * 4}%` }">
      <el-checkbox @change="selectCheckbox(module)" class="checked-box-label" :label="module.menuId">
        {{ module.menuName }}
      </el-checkbox>
