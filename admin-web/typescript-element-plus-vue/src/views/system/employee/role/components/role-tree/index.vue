 ...
 * @LastEditTime: 2022-06-05 22:59:49
 * @LastEditors: LiHaiFan
 * @Description:
 * @FilePath: \typescript-element-plus-vue\src\views\system\employee\role\components\role-tree\index.vue
-->
<template>
  <div>
    <div class="tree-header">
      <p>设置角色对应的功能操作、后台管理权限</p>
      <el-button v-privilege="'system:role:menu:update'" v-if="selectRoleId" type="primary" @click="saveChange"> 保存 </el-button>
    </div>
