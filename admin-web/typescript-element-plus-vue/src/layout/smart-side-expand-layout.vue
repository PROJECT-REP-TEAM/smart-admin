<template>
  <el-container :class="['admin-layout', 'smart-scroll']" style="min-height: 100%">
    <!-- 侧边菜单 side-menu -->
    <el-aside theme="light" :class="['side-menu', 'smart-scroll']" :collapsed="collapsed" :trigger="null">
      <expand-side-menu />
    </el-aside>
  ...
  3、底部（一般是公司版权信息）
 -->
    <el-container class="admin-layout-main smart-scroll" :style="`height: ${windowHeight}px`" id="smartAdminMain">
      <!-- 顶部头部信息 -->
      ...
      <!-- footer 版权公司信息 -->
      <el-footer class="smart-layout-footer">
        <smart-footer />
      </el-footer>
