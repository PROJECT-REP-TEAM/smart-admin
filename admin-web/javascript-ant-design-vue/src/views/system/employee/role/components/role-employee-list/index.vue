...
<template>
  <div>
    <div class="header">
      ...
      <div>
        <a-button class="button-style" v-if="selectRoleId" type="primary" @click="addRoleEmployee" v-privilege="'role:addEmployee'"
          >添加员工</a-button
        >
        <a-button class="button-style" v-if="selectRoleId" type="primary" danger @click="batchDelete" v-privilege="'role:deleteEmployee'"
          >批量移除</a-button
        >
      </div>
    </div>
    ...
    >
      <template #bodyCell="{ text, record, index, column }">
        ...
        <template v-if="column.dataIndex === 'operate'">
          <a @click="deleteEmployeeRole(record.employeeId)" v-privilege="'role:deleteEmployee'">移除</a>
        </template>
      </template>
    </a-table>
