        ...
        <a-popover placement="right" v-if="props.showMenu">
          <template #content>
            <div style="display: flex; flex-direction: column">
              <a-button type="text" @click="addDepartment(item.dataRef)" v-privilege="'department:add'">添加下级</a-button>
              <a-button type="text" @click="updateDepartment(item.dataRef)" v-privilege="'department:edit'">修改</a-button>
              <a-button
                type="text"
