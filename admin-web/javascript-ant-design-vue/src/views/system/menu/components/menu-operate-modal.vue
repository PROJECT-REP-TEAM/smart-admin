...
<template>
  ...
  >
    ...
    >
      ...
      <a-form-item
        v-if="form.menuType != MENU_TYPE_ENUM.POINTS.value"
        :label="form.menuType === MENU_TYPE_ENUM.MENU.value ? '上级菜单' : '上级目录'"
      >
      ...
      >
        ...
        >
          <a-switch
            v-model:checked="form.cacheFlag"
            checked-children="是"
        ...
        >
          <a-switch
            v-model:checked="form.frameFlag"
            checked-children="是"
            un-checked-children="否"
          />
        </a-form-item>
        <a-form-item label="显示状态" name="frameFlag">
          <a-switch
            v-model:checked="form.visibleFlag"
            checked-children="显示"
