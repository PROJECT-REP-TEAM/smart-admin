...
<template>
  <div class="user-header">
    <a-page-header :title="welcomeSentence" :sub-title="departmentName" :avatar="{ src: 'https://zhuoda.vip/images/blog/profile-128-128.jpg' }">
      <template #tags>
        <a-tag color="blue">努力工作</a-tag>
        <a-tag color="success">主动 / 皮实 / 精进 / 可靠 / 创新</a-tag>
      </template>
      <template #extra>
        <p>{{ dayInfo }}</p>
      </template>
