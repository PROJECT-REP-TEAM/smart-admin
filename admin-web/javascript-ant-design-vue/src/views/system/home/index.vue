...
<template>
  ...
  <a-row :gutter="[10,10]">
    ...
    <a-col :span="8">
      <a-card class="no-footer" title="本月业绩">
    ...
    <a-col :span="8">
      <a-card class="no-footer" title="本月订单数">
        <div class="content statistice">
    ...
    <a-col :span="8">
      <a-card class="no-footer" title="移动客户端">
    ...
    <a-col :span="12">
      <a-card title="待办事项">
        <div class="content large wait-handle">
          <p>
            <a-tag color="#108ee9">审批</a-tag>
            有{{ 0 }}个审批待审核
            <a>查看更多></a>
          </p>
          <p>
            <a-tag color="#f50">退款</a-tag>
            有{{ 0 }}个退款被驳回
            <a>查看更多></a>
          </p>
          <p>
            <a-tag color="#2db7f5">缺陷</a-tag>
            有{{ 0 }}个缺陷被找到
            <a>查看更多></a>
          </p>
          <p>
            <a-tag color="#d3adf7">尾款</a-tag>
            有{{ 0 }}元尾款待收回
            <a>查看更多></a>
          </p>
          <p>
            <a-tag color="#87d068">合同</a-tag>
            有{{ 0 }}个合同工客户已签署
            <a>查看更多></a>
          </p>
          <p>
            <a-tag color="#108ee9">问题</a-tag>
            有{{ 0 }}个问题被驳回
            <a>查看更多></a>
          </p>
          <p>
            <a-tag color="#f50">能量</a-tag>
            有{{ 0 }}个能量被收取
            <a>查看更多></a>
          </p>
        </div>
    ...
    <a-col :span="12">
      <a-card title="缺陷排行榜">
        ...
        <div class="content large">
          <a-table :columns="bugColumns" :dataSource="bugList" :pagination="false" :scroll="{ y: 300 }" bordered
                   size="small">
