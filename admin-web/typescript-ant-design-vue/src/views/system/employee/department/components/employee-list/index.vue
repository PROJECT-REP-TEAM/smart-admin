  ...
  <a-card class="employee-container">
    <div class="header">
      ...
      <div class="query-operate">
        <a-radio-group
          v-model:value="params.disabledFlag"
        ...
        >
          <template #enterButton>
            <a-button
              v-privilege="'system:employee:query'"
    ...
    <div class="btn-group">
      ...
      <a-button
        ...
        >调整部门</a-button
      >
      <a-button v-privilege="'system:employee:delete'" class="btn" @click="batchDelete"
        >批量删除</a-button
      >
    </div>
      ...
      <template #bodyCell="{ text, record, index, column }">
        ...
        <template v-else-if="column.dataIndex === 'operate'">
          ...
          <a-button
            ...
            type="link"
            size="small"
            @click="resetPassword(record.employeeId)"
            >重置密码</a-button
          >
          <a-button
    ...
    <UpdateEmployeeDepartmentModal
      ref="updateEmployeeDepartmentModal"
      @reloadList="queryEmployee"
    />
  </a-card>
</template>
