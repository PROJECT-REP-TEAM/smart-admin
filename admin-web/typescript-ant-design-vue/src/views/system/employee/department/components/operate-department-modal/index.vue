...
-->
<template>
  <a-modal v-model:visible="visible" :title="form.id ? '编辑部门' : '添加部门'" @ok="handleOk">
    <a-form ref="formRef" :model="form" :rules="rules" layout="vertical">
      <a-form-item label="上级部门" name="parentId" v-if="form.parentId != 0">
        <DepartmentTreeSelect ref="departmentTreeSelect" v-model:value="form.parentId" :init="false" />
      </a-form-item>
