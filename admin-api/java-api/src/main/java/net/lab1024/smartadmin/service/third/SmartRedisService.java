...
public class SmartRedisService {
    ...
    public boolean expire(String key, long time) {
        ...
        try {
            ...
            log.error("redis service 指定失效时间-发生异常：", e);
            return false;
        }
    }
    ...
    public boolean hasKey(String key) {
        try {
            ...
            log.error("redis service 判断key是否存在-发生异常：", e);
            return false;
        }
    }
    ...
    public boolean set(String key, String value) {
        try {
            ...
            log.error("redis service set-发生异常：", e);
            return false;
        }
    ...
    public List<String> mGet(List<String> keyList) {
        return redisValueOperations.multiGet(keyList);
    }
