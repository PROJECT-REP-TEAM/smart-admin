...
public class RoleEmployeeController extends AdminBaseController {
    ...
    public ResponseDTO<String> removeEmployeeList(@Valid @RequestBody RoleEmployeeBatchDTO removeDTO) {
    ...
    public ResponseDTO<String> addEmployeeList(@Valid @RequestBody RoleEmployeeBatchDTO addDTO) {
        return roleEmployeeService.batchAddRoleEmployee(addDTO);
    }
