...
import net.lab1024.smartadmin.module.support.heartbeat.core.HeartBeatRecord;
import net.lab1024.smartadmin.module.support.heartbeat.core.IHeartBeatRecordHandler;
import net.lab1024.smartadmin.common.util.SmartBeanUtil;
import net.lab1024.smartadmin.module.support.heartbeat.domain.HeartBeatRecordEntity;
