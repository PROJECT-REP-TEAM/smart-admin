package net.lab1024.smartadmin.module.support.jwe;
...
public class JweAspect {
    ...
    @Before("@annotation(net.lab1024.smartadmin.module.support.jwe.JweDecrypt)")
    ...
    @AfterReturning(returning = "object", pointcut = "@annotation(net.lab1024.smartadmin.module.support.jwe.JweEncrypt)")
